                    ...
                    <div class="col-md-6">
                        ...
                        @csrf <!-- {{ csrf_field() }} -->
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="sp"  value="{{$data->name}}" name="name"  placeholder="Enter">
                            </div>

                            <div class="form-group">
                                <label for="price">Giá(VNĐ)</label>
                                <input type="text" class="form-control" id="price" value="{{$data->price}}"  name="gia"  placeholder="Enter: 10.000.000">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <img src="{{$data->feature_image_path}}" width="100px" height="100px"/>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <img src="{{$value->image_path}}" width="100px" height="100px">
                                    @endforeach
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2"  name="tags[]"   multiple="multiple"  >
                                    @foreach($data->product_tags as $tags)
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control tynimce_init"   name="contents" id="contents" rows="3" >{{$data->content}}</textarea>
                            </div>
